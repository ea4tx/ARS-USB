...
La primera versión del ARS aparece en 1996 e incluía la Tarjeta RCI :doc:`rci` – placa de interface con el mando del motor. 6 años más tarde, se rediseña la tarjeta y pasa a llamarse: Tarjeta RCI-SE (RCI – Second Edition). 
